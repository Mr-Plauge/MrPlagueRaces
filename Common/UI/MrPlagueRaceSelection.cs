...
namespace MrPlagueRaces.Common.UI
{
	public class MrPlagueRaceSelection : UIState
	{
		...
		public override void OnInitialize()
		{
			...
			Texture2D BlankRaceIcon = GetTexture("MrPlagueRaces/Common/UI/BlankRaceButton");
			Texture2D HumanRaceIcon = GetTexture("MrPlagueRaces/Common/UI/HumanRaceButton");
			...
			Texture2D GoblinRaceIcon = GetTexture("MrPlagueRaces/Common/UI/GoblinRaceButton");
			...
			Texture2D KenkuRaceIcon = GetTexture("MrPlagueRaces/Common/UI/KenkuRaceButton");
			...
			Texture2D TabaxiRaceIcon = GetTexture("MrPlagueRaces/Common/UI/TabaxiRaceButton");
			...
			Texture2D DragonkinRaceIcon = GetTexture("MrPlagueRaces/Common/UI/DragonkinRaceButton");
			...
			Texture2D MerfolkRaceIcon = GetTexture("MrPlagueRaces/Common/UI/MerfolkRaceButton");
			...
			Texture2D MushfolkRaceIcon = GetTexture("MrPlagueRaces/Common/UI/MushfolkRaceButton");
			...
			Texture2D DerpkinRaceIcon = GetTexture("MrPlagueRaces/Common/UI/DerpkinRaceButton");
			...
			Texture2D KoboldRaceIcon = GetTexture("MrPlagueRaces/Common/UI/KoboldRaceButton");
			...
			Texture2D SkeletonRaceIcon = GetTexture("MrPlagueRaces/Common/UI/SkeletonRaceButton");
			...
			Texture2D VampireRaceIcon = GetTexture("MrPlagueRaces/Common/UI/VampireRaceButton");
			...
			Texture2D FluftrodonRaceIcon = GetTexture("MrPlagueRaces/Common/UI/FluftrodonRaceButton");
		...
		private Texture2D RaceDisplay()
		{
			...
			{
				case 0:
					return GetTexture("MrPlagueRaces/Common/UI/HumanRaceDisplay");
				case 1:
					return GetTexture("MrPlagueRaces/Common/UI/GoblinRaceDisplay");
				case 2:
					return GetTexture("MrPlagueRaces/Common/UI/KenkuRaceDisplay");
				case 3:
					return GetTexture("MrPlagueRaces/Common/UI/TabaxiRaceDisplay");
				case 4:
					return GetTexture("MrPlagueRaces/Common/UI/DragonkinRaceDisplay");
				case 5:
					return GetTexture("MrPlagueRaces/Common/UI/MerfolkRaceDisplay");
				case 6:
					return GetTexture("MrPlagueRaces/Common/UI/MushfolkRaceDisplay");
				case 7:
					return GetTexture("MrPlagueRaces/Common/UI/DerpkinRaceDisplay");
				case 8:
					return GetTexture("MrPlagueRaces/Common/UI/KoboldRaceDisplay");
				case 9:
					return GetTexture("MrPlagueRaces/Common/UI/SkeletonRaceDisplay");
				case 10:
					return GetTexture("MrPlagueRaces/Common/UI/VampireRaceDisplay");
				case 11:
					return GetTexture("MrPlagueRaces/Common/UI/FluftrodonRaceDisplay");
				default:
					return GetTexture("MrPlagueRaces/Common/UI/BlankRaceDisplay");
			}
		}
