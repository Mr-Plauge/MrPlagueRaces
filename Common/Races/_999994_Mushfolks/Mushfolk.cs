...
namespace MrPlagueRaces.Common.Races._999994_Mushfolks
{
	public class Mushfolk : Race
	{
		...
		public override string RaceLore1 => "An unusual breed of" + "\nfungi, interestingly" + "\npossessing sentience" + "\nand mobility.";
		...
		public override string RaceAllDamageDisplayText => "[c/FC4258:-15%]";
        ...
        public override string RaceTimeDisplayText => "Any";
