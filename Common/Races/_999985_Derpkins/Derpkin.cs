...
namespace MrPlagueRaces.Common.Races._999985_Derpkins
{
	public class Derpkin : Race
	{
		...
		public override string RaceAdditionalNotesDescription1 => "-Can autojump";
		...
		public override string RaceHealthDisplayText => "[c/FC4258:-10%]";
		...
		public override string RaceDefenseDisplayText => "[c/FC4258:-4]";
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
		{
            ...
            for (int i = 0; i < 51; i++)
            {
                Main.playerHairTexture[i] = ModContent.GetTexture($"MrPlagueRaces/Content/RaceTextures/Derpkin/Hair/Derpkin_Hair_{i + 1}");
                Main.playerHairAltTexture[i] = ModContent.GetTexture($"MrPlagueRaces/Content/RaceTextures/Derpkin/Hair/Derpkin_Hair_{i + 1}");
            }
