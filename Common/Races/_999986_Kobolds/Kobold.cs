...
namespace MrPlagueRaces.Common.Races._999986_Kobolds
{
	public class Kobold : Race
	{
		...
		public override string RaceAdditionalNotesDescription1 => "-Stats decrease in sunlight ([c/FC4258:-4] Defense, [c/FC4258:-20%] Attack Damage, [c/FC4258:-50%] Jump Height)";
		...
		public override string RaceMeleeDamageDisplayText => "[c/FC4258:-10%]";
		...
		public override string RaceGoodBiomesDisplayText => "Underground";
		public override string RaceBadBiomesDisplayText => "Surface";
		public override string RaceDietDisplayText => "Omnivore";
		public override string RaceTimeDisplayText => "Night";
