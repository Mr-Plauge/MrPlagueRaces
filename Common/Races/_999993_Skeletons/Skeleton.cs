...
namespace MrPlagueRaces.Common.Races._999993_Skeletons
{
	public class Skeleton : Race
	{
		...
		public override string RaceHealthDisplayText => "[c/FC4258:-25%]";
		...
		public override string RaceDietDisplayText => "None";
